...
<template>
  ...
  <div class="text-center">
    <h1>
      <span class="fade-in" >{{ error.statusCode }}</span>
    </h1>
    <h3 class="fadeIn uppercase">{{ error.message }}</h3>
    <button type="button" @click="handleClearError">Return To Home</button>
  </div>
</div>
</template>
...
.flex-container {
  ...
  .text-center {text-align: center;}
    ...
    h3 {
      ...
      .fade-in {        animation: fadeIn 2s ease infinite;    }
